...
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/failex234/LARBS/master/dwm/vprogs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Luke's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured dwm FreeBSD desktop.\\n\\n-Felix" 10 60
	}
